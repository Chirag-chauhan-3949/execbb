...
//       localStorage.setItem('jwt', jwt);  // Store the JWT for authenticated requests
...
//       <input type="text" placeholder="Email or Username" onChange={(e) => setIdentifier(e.target.value)} required />
