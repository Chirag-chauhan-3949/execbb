      ...
      >
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img
              alt="Executive Business Brokers"
              src={logo}
                ...
                {buyers.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-auto">
                      <a
                        href={item.href}
                        className="text-left block font-semibold text-gray-900"
                      >
                        {item.name}
                        <span className="absolute inset-0" />
                      </a>
                      <p className="text-left mt-1 text-gray-600">
                        {item.description}
                      </p>
                    </div>
                  </div>
